...
def main():
    ...
    with open('different_approach_re_calculation_results.csv', 'w', newline='') as csvfile:
                    ...
                    for VE_kids in VE_vals:
                        for VE_adults in VE_vals:
                            for VE_grandparents in VE_vals:
                                Re_kids = calculate_re(R0_kids,VE_kids)
                                Re_adults = calculate_re(R0_adults,VE_adults)
                                Re_grandparents = calculate_re(R0_grandparents, VE_grandparents)
